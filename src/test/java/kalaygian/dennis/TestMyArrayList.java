 ...
 *
 * I have three tests commented out, as I'm not sure if the exceptions are something that I should be testing / if
 * I am even testing the right exception for that matter.
 */
